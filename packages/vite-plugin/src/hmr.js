 ...
 */
export function analyzeAstForHmr(ast, _filePath) {
  const state = {
 ...
 */
export function canHotReload(oldState, newState) {
 ...
 */
export function handleAstroHmr(ctx, oldState, newState) {
 ...
 */
export function createHmrClientCode(filePath) {
  return `
 ...
 */
export function injectHmrCode(jsCode, filePath, dev) {
  if (!dev) {
    return jsCode;
  }
 ...
 */
function extractStyleBlocks(ast) {
  const styleBlocks = [];
 ...
 */
export function handleCssUpdate(ctx, oldState, newState) {
 ...
 */
export function createErrorOverlay(error, filePath) {
