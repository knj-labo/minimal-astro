...
export { buildHtml, buildHtmlToStream, createStreamingHtmlBuilder } from './core/html-builder.js';
...
// Type exports
export type * from './core/../types/ast.js';
export type { ParseOptions } from './core/parse.js';
export type { HtmlBuilderOptions, StreamingOptions } from './core/html-builder.js';