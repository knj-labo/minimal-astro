...
export interface CollectionConfig {
    ...
    /**
     * File patterns to include (e.g., ['*.md', '*.json'])
     */
    patterns?: string[];
}
...
export interface ContentAPI {
     ...
     * Get entry by ID
     */
    getEntry<T = Record<string, unknown>>(collection: string, id: string): Promise<ContentEntry<T> | null>;
    /**
     * Get entry by slug
     */
    getEntryBySlug<T = Record<string, unknown>>(collection: string, slug: string): Promise<ContentEntry<T> | null>;
    /**
     * Query builder
     */
