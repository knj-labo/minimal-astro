	...
	return {
		render(ast: FragmentNode): VueRenderResult {
			...
			const scripts = hydrate
				? generateVueHydrationScripts(hydrationData)
				: undefined;
 ...
 * Create SSR renderer
 */
export function createVueSSRRenderer(
	options: Omit<VueRendererOptions, "mode"> = {},
) {
 ...
 */
export function createVueClientRenderer(
	options: Omit<VueRendererOptions, "mode"> = {},
) {
